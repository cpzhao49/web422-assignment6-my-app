...
*
* Name: __Inae Kim____________________ Student ID: __132329202____________ Date: ________________
*
...
export default function Home() {
  return (
    <>
    <Image src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" fluid="true" rounded="true"></Image>
    <br></br>
    <br></br>
    <Row>
      <Col md={6}>
      ...
      <br></br><br></br><a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art</a>
        </Col>
        </Row>
    </>
